package com.compastbc.synchronization.bundle;
...
abstract public class Item {
        ...
        try {
            ...
            if (value == null) {
                if (defaultValue == null) {
                    throw new IOException(String.format(Locale.US, "missing \"%s\" property", key));
                } else {
                    value = defaultValue;
                }
            }
            ...
            throw new IOException(String.format(Locale.US, "cannot read \"%s\" property", key));
        }
    }
    ...
    public long getLongProperty(String key, boolean required) throws IOException {
        try {
            ...
            throw new IOException(String.format(Locale.US, "\"%s\" is not an integer", key));
        }
    }
     ...
     * @throws IOException This method is invoked multiple times until all content has been read.
     */
