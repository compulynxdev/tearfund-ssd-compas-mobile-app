...
import com.compastbc.core.base.AbstractBaseBottomSheetDialog;
...
public abstract class BaseBottomSheetDialog extends AbstractBaseBottomSheetDialog {
    ...
    public void getAccessToken(BaseActivity.TokenCallback tokenCallback) {
        if (getBaseActivity() != null) getBaseActivity().getAccessToken(tokenCallback);
    }
